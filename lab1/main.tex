...
\title{El reactor con nucleo de hierro}				% Title
\author{ML202C}								% Author
\date{23 Junio 2020}							% Date
...
\begin{titlepage}
	...
	\textsc{\Large ML202-C}\\[0.5 cm]				% Course Code
...
\begin{enumerate}
    ...
    \captionsetup{labelformat=empty}
    \caption{\label{pi} Circuito equivalente.}
    \end{figure}
